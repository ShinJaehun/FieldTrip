...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + TABLE_PLACES + " VALUES ('1', 'history', '국립제주박물관', 'p1pic.jpg', 'p1map.jpg', 'lat1, long1', '국립제주박물관입니다.', '국립제주박물관은 별로 볼건 없고... 세금 낭비인 곳이다.');");
        db.execSQL("INSERT INTO " + TABLE_PLACES + " VALUES ('2', 'history', '신재훈님네집', 'p2pic.jpg', 'p2map.jpg', 'lat2, long2', '신재훈님네 집입니다.', '신재훈님께서 살고 계신 집이다.');");
    }
