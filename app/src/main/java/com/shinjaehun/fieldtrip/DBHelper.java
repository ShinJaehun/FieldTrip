...
//    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + TABLE_PLACES + " VALUES ('1', 'history', '국립제주박물관', 'jejumuseum', 'geo:33.5140015,126.5467813?q=국립제주박물관', '국립제주박물관입니다.'," +
                ...
                "\n" +
                "6개의 전시실로 이루어진 상설전시실에서는 제주 고유의 문화를 체계적으로 선보이고 있으며, 기획전시실에서는 해마다 다양한 주제의 특별전을 개최하고 있습니다.', 0, null, null, null, null);");
        db.execSQL("INSERT INTO " + TABLE_PLACES + " VALUES ('2', 'people', '신재훈님네집', 'jehunshin', 'lat2, long2', '신재훈님네 집입니다.', '신재훈님께서 살고 계신 집이다.', 0, null, null, null, null);");
        db.execSQL("INSERT INTO " + TABLE_PLACES + " VALUES ('3', 'history', '삼양동선사유적지', 'samyangprehistoric', 'lat3, long3', '삼양동 선사시대 유적지입니다.', '선사시대 사람들이 살던 유적지입니다.', 0, null, null, null, null);");
        //테이블 초기화
    }
